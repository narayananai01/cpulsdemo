...
label3msg=Label(hai,text="Password",font=("heather",14),fg="black")
label3msg.grid(row=3,column=20,pady=10)
tbEntryb=Entry(hai, width=60)
tbEntryb.grid(row=3,column=25)

btnlo=Button(hai,text="Login",font=("heather",14),fg="White",bg="Green",command=login) 
...
def personaldetails():
    ...
    Labeltitle=Label(win,text="Personal Details Form",font=("DEnmarK",20),fg="White",bg="Blue")
    Labeltitle.grid(row=0,column=25)

    label1msg=Label(win,text="Name",font=("heather",14),fg="black")
    label1msg.grid(row=1,column=20,pady=10)
    tbEntrya=Entry(win, width=60)
    tbEntrya.grid(row=1,column=25)

    label2msg=Label(win,text="Gender",font=("heather",14),fg="black")
    label2msg.grid(row=2,column=20,pady=10)
    ...
    label3msg=Label(win,text="D.O.B",font=("heather",14),fg="black")
    label3msg.grid(row=3,column=20,pady=10)
    tbEntryc=Entry(win, width=60)
    tbEntryc.grid(row=3,column=25)

    label4msg=Label(win,text="Birth City",font=("heather",14),fg="black")
    ...
    label5msg=Label(win,text="State",font=("heather",14),fg="black")
    ...
    label6msg=Label(win,text="Phone No.",font=("heather",14),fg="black")
    ...
    btnsub=Button(win,text="Submit",font=("heather",14),fg="White",bg="Green",command=Submit)
    btnsub.grid(row=7,column=1)

    btnclr=Button(win,text="Clear",font=("heather",14),fg="White",bg="Blue", command=Clear)
    btnclr.grid(row=7,column=2)

    btnclo=Button(win,text="Close",font=("heather",14),fg="White",bg="Red")
...
def math_operation():
    ...
    Labeltitle=Label(roo,text="Arithematic Operations",font=("DEnmarK",16),fg="green")
